...
export declare class SubNumberOrdersReport extends APIResource {
    /**
...
export declare namespace SubNumberOrdersReportCreateResponse {
    interface Data {
        /**
...
export declare namespace SubNumberOrdersReportRetrieveResponse {
    interface Data {
        /**
         * Identifies the resource.
         */
...
export declare namespace SubNumberOrdersReport {
    export { type SubNumberOrdersReportCreateResponse as SubNumberOrdersReportCreateResponse, type SubNumberOrdersReportRetrieveResponse as SubNumberOrdersReportRetrieveResponse, type SubNumberOrdersReportDownloadResponse as SubNumberOrdersReportDownloadResponse, type SubNumberOrdersReportCreateParams as SubNumberOrdersReportCreateParams, };
}
