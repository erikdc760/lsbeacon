...
export declare namespace AutoRechargePrefUpdateResponse {
    interface Data {
        /**
...
export declare namespace AutoRechargePrefListResponse {
    interface Data {
        /**
         * The unique identifier for the auto recharge preference.
         */
...
export declare namespace AutoRechargePrefs {
    export { type AutoRechargePrefUpdateResponse as AutoRechargePrefUpdateResponse, type AutoRechargePrefListResponse as AutoRechargePrefListResponse, type AutoRechargePrefUpdateParams as AutoRechargePrefUpdateParams, };
}
