...
export declare namespace SupportingDocumentCreateResponse {
    interface Data {
        id: string;
        /**
...
export declare namespace SupportingDocumentListResponse {
    interface Data {
        id: string;
        /**
         * Supporting document creation timestamp in ISO 8601 format
...
export declare namespace SupportingDocuments {
    export { type SupportingDocumentCreateResponse as SupportingDocumentCreateResponse, type SupportingDocumentListResponse as SupportingDocumentListResponse, type SupportingDocumentCreateParams as SupportingDocumentCreateParams, };
}
