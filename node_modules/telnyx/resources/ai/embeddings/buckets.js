...
class Buckets extends resource_1.APIResource {
    ...
    retrieve(bucketName, options) {
        return this._client.get((0, path_1.path) `/ai/embeddings/buckets/${bucketName}`, options);
    }
    /**
    ...
    delete(bucketName, options) {
        return this._client.delete((0, path_1.path) `/ai/embeddings/buckets/${bucketName}`, {
            ...options,
