...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, role, isMobileMenuOpen, onCloseMobileMenu, onOpenBeacon }) => {
  const getTabs = (): { name: TabType; icon: React.ReactNode }[] => {
    return [
      ...
      { 
        name: 'Conversations', 
        icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z" /><path d="M8 12h.01" /><path d="M12 12h.01" /><path d="M16 12h.01" /></svg> 
      },
      { 
        name: 'Pain Tracker', 
        icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="M12 2v4" /><path d="M12 18v4" /><path d="M2 12h4" /><path d="M18 12h4" /><circle cx="12" cy="12" r="3" /></svg> 
      },
      { 
        name: 'Personal Tracker', 
        icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 3h12l4 6-10 12L2 9Z" /><path d="M11 3 8 9l3 12 3-12-3-6Z" /><path d="M2 9h20" /></svg> 
      },
      { 
        name: 'Company Arena', 
      ...
      { 
        ...
        icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 10V4a2 2 0 0 0-2-2h-6a2 2 0 0 0-2 2v6"/><rect x="15" y="10" width="4" height="4"/><path d="M17 14v5"/></svg> 
      },
      { 
