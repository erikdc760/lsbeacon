...
class Actions extends resource_1.APIResource {
     ...
     */
    disable(id, options) {
        return this._client.post((0, path_1.path) `/managed_accounts/${id}/actions/disable`, options);
    }
    /**
     ...
     * ```
     */
    enable(id, body = {}, options) {
        return this._client.post((0, path_1.path) `/managed_accounts/${id}/actions/enable`, { body, ...options });
    }
}
