...
export type TranscriptionEngineDeepgramConfig = TranscriptionEngineDeepgramConfig.DeepgramNova2 | TranscriptionEngineDeepgramConfig.DeepgramNova3;
export declare namespace TranscriptionEngineDeepgramConfig {
    interface DeepgramNova2 {
...
export interface TranscriptionStartRequest {
    ...
    transcription_engine_config?: TranscriptionEngineGoogleConfig | TranscriptionEngineTelnyxConfig | TranscriptionStartRequest.DeepgramNova2Config | TranscriptionStartRequest.DeepgramNova3Config | TranscriptionEngineAzureConfig | TranscriptionEngineAConfig | TranscriptionEngineBConfig;
    /**
...
export interface ActionStartTranscriptionParams {
     ...
     */
    transcription_engine?: 'Google' | 'Telnyx' | 'Deepgram' | 'Azure' | 'A' | 'B';
    transcription_engine_config?: TranscriptionEngineGoogleConfig | TranscriptionEngineTelnyxConfig | ActionStartTranscriptionParams.DeepgramNova2Config | ActionStartTranscriptionParams.DeepgramNova3Config | TranscriptionEngineAzureConfig | TranscriptionEngineAConfig | TranscriptionEngineBConfig;
    /**
     * Indicates which leg of the call will be transcribed. Use `inbound` for the leg
     * that requested the transcription, `outbound` for the other leg, and `both` for
     * both legs of the call. Will default to `inbound`.
