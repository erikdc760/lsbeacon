...
export declare namespace CivicAddressRetrieveResponse {
    interface Data {
        /**
...
export declare namespace CivicAddressListResponse {
    interface Data {
        /**
         * Uniquely identifies the resource.
         */
...
export declare namespace CivicAddresses {
    export { type CivicAddressRetrieveResponse as CivicAddressRetrieveResponse, type CivicAddressListResponse as CivicAddressListResponse, type CivicAddressRetrieveParams as CivicAddressRetrieveParams, type CivicAddressListParams as CivicAddressListParams, };
}
