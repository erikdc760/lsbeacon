...
export class PhoneNumberConfigurations extends APIResource {
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/porting_orders/phone_number_configurations', (DefaultFlatPagination), { query, ...options });
    }
}
//# sourceMappingURL=phone-number-configurations.mjs.map