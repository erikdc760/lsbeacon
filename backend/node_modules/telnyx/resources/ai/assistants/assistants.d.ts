 ...
 * user.
 */
export type AssistantTool = InferenceEmbeddingWebhookToolParams | RetrievalTool | AssistantTool.Handoff | HangupTool | AssistantTool.Transfer | AssistantTool.Refer | AssistantTool.SendDtmf | AssistantTool.SendMessage;
